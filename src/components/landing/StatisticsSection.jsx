    ...
    <section className="py-24 bg-slate-50 dark:bg-background border-y border-slate-200 dark:border-white/5 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-xs font-bold text-primary-500 tracking-widest uppercase mb-2">Trusted By Thousands</h2>
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">Proven Results That Speak For Themselves</h3>
        </div>
